	...
	if DoesEntityExist(vehicle) then
		if IsPedInAnyVehicle(player) or IsPedInAnyHeli(player) then
			if vehicleplate ~= nil and clostestvehicleplate ~= nil then
					...
					if isvehiclefound then
						if (islocked == 1)then
							...
							exports.pNotify:SendNotification(
								{
								text = "El vehículo <b style='color:yellow;'>" .. GetLabelText(GetDisplayNameFromVehicleModel(GetEntityModel(vehicle))) .. "</b> está <b style='color:red;'>bloqueado</b>.",
								type = "error",
								timeout = 2000,
								layout = "bottomCenter",
								queue = "bloqueo"
							...
							exports.pNotify:SendNotification(
								{
								text = "El vehículo <b style='color:yellow;'>" .. GetLabelText(GetDisplayNameFromVehicleModel(GetEntityModel(vehicle))) .. "</b> está <b style='color:green;'>desbloqueado</b>.",
								type = "success",
								timeout = 2000,
								layout = "bottomCenter",
								queue = "bloqueo"
				...
				exports.pNotify:SendNotification(
					{
					text = "No hay un vehículo para bloquear",
					type = "error",
					timeout = 2000,
					layout = "bottomCenter",
					queue = "bloqueo"
			...
			if not table.empty(VehicleList) then
					...
					if isvehiclefound then
						if not foundclostestvehicle then 
							if (islockedHandle == 1)then
								...
								TaskPlayAnim(GetPlayerPed(PlayerId()), dict, "fob_click_fp", 8.0, 8.0, -1, 48, 1, false, false, false)

								--Notify("Le véhicule ~y~" .. GetLabelText(GetDisplayNameFromVehicleModel(GetEntityModel(vehicleHandle))) .. "~w~ est ~r~vérouiller ~w~.")
								exports.pNotify:SendNotification(
									{
									text = "El vehículo <b style='color:yellow;'>" .. GetLabelText(GetDisplayNameFromVehicleModel(GetEntityModel(vehicleHandle))) .. "</b> está <b style='color:red;'>bloqueado</b>.",
									type = "error",
									timeout = 2000,
									layout = "bottomCenter",
									queue = "bloqueo"
								...
								exports.pNotify:SendNotification(
									{
									text = "El vehículo <b style='color:yellow;'>" .. GetLabelText(GetDisplayNameFromVehicleModel(GetEntityModel(vehicleHandle))) .. "</b> está <b style='color:green;'>desbloqueado</b>.",
									type = "success",
									timeout = 2000,
									layout = "bottomCenter",
									queue = "bloqueo"
							...
							if (islockedclostestvehicle == 1)then
								...
								PlayVehicleDoorCloseSound(clostestvehicle, 1)
								...
								exports.pNotify:SendNotification(
									{
									text = "El vehículo <b style='color:yellow;'>" .. GetLabelText(GetDisplayNameFromVehicleModel(GetEntityModel(clostestvehicle))) .. "</b> está <b style='color:red;'>bloqueado</b>.",
									type = "error",
									timeout = 2000,
									layout = "bottomCenter",
									queue = "bloqueo"
								...
								PlayVehicleDoorOpenSound(clostestvehicle, 0)
								...
								exports.pNotify:SendNotification(
									{
									text = "El vehículo <b style='color:yellow;'>" .. GetLabelText(GetDisplayNameFromVehicleModel(GetEntityModel(clostestvehicle))) .. "</b> está <b style='color:green;'>desbloqueado</b>.",
									type = "success",
									timeout = 2000,
									layout = "bottomCenter",
									queue = "bloqueo"
						...
						exports.pNotify:SendNotification(
							{
							text = "El vehículo que intentas abrir, <b style='color:red;'>no es tuyo</b>.",
							type = "error",
							timeout = 2000,
							layout = "bottomCenter",
							queue = "bloqueo"
				...
				exports.pNotify:SendNotification(
					{
					text = "Ningún vehículo para bloquear, o el vehículo ya está bloqueado",
					type = "error",
					timeout = 2000,
					layout = "bottomCenter",
					queue = "bloqueo"
		...
		if DoesEntityExist(vehicleHandle) then
			if vehicleHandleplate ~= nil then
				...
				if isvehiclefound then
					...
					exports.pNotify:SendNotification(
						{
						text = "El vehículo que intentas abrir, está <b style='color:red;'>bloqueado</b>.",
						type = "error",
						timeout = 2000,
						layout = "bottomCenter",
						queue = "bloqueo"
